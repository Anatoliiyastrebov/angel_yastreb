...
const Success: React.FC = () => {
  ...
  const qtype: QuestionnaireType =
    rawType && types.includes(rawType as QuestionnaireType) ? (rawType as QuestionnaireType) : 'infant';

  const anketaFreshHref = `/anketa?type=${encodeURIComponent(qtype)}&lang=${language}&fresh=1`;
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-[calc(100vh-80px)]">
        <div className="card-wellness text-center max-w-md animate-slide-up">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-4">{t('thankYou')}</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link href={anketaFreshHref} className="btn-primary flex items-center justify-center gap-2 flex-1">
        ...
        <div
          className="fixed bottom-1/3 right-1/4 w-48 h-48 bg-primary/10 rounded-full blur-3xl pointer-events-none animate-pulse-soft"
